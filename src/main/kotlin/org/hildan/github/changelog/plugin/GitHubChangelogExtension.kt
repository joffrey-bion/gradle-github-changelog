...
interface GitHubChangelogExtension {
    /**
     ...
     */
    val githubUser: Property<String>
    /**
     ...
     */
    val title: String = DEFAULT_CHANGELOG_TITLE
    /**
     ...
     * provided.
     */
    val showUnreleased: Property<Boolean> = DEFAULT_SHOW_UNRELEASED
    /**
     ...
     */
    val releaseUrlTemplate: String? = null
    /**
     ...
     */
    val diffUrlTemplate: String? = null
    /**
     ...
     */
    val outputFile: File = File("${project.projectDir}/CHANGELOG.md")

    /**
     * The file to write the change log of the unreleased changes to.
     * This is meant to be used as body for the new GitHub release.
     */
    val latestReleaseBodyFile: File = File("${project.buildDir}/reports/changelog/latest-release-body.md")
